...
class IntVector2:
    ...
    def __radd__(self, other: IntVector2 | tuple[int, int]) -> IntVector2:
        _ensure_2_elements(other)
        if isinstance(other, IntVector2):
            return IntVector2(other.x + self.x, other.y + self.y)
    ...
    def __rsub__(self, other: IntVector2 | tuple[int, int]) -> IntVector2:
        _ensure_2_elements(other)
        if isinstance(other, IntVector2):
            return IntVector2(other.x - self.x, other.y - self.y)
